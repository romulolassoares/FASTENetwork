...
const creatAndSave = async (req,res) => {
...
const verifyNetworkName = (req,res) => {
   ...
   const startNetwork = async (rededatabase) => {
...
const stopNetwork = async (rededatabase) => {
   const networks = path.join(process.cwd(), 'networks');
   const pathNetworks = networks + '/' + rededatabase.nomeRede;
 ...
 const deployCC = async (rededatabase) => {
